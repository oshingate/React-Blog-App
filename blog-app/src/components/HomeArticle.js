        ...
        {this.props.article ? (
          <article className='home-article-card'>
            <div className='article-card-header flex jsb'>
              <NavLink to={`/profile/${this.props.article.author.username}`}>
                <div className='flex article-card-author'>
                  <img
                    src={
                      this.props.article.author.image
                        ? this.props.article.author.image
                  ...
                  <div className='article-card-author'>
                    <h5>{this.props.article.author.username}</h5>
                    <h6>
                      {moment(this.props.article.createdAt).format('LLLL')}
                    </h6>
                  </div>
                </div>
              </NavLink>
              ...
              <div className='article-card-likes'>
                ...
                <span>{this.props.article.favoritesCount}</span>
              </div>
            </div>
            ...
            <div className='article-card-footer flex jsb'>
              <div className='flex center'>
                <NavLink
                  to={`/articles/${this.props.article.slug}`}
